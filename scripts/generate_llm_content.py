...
SUMMARIES = {
    ...
    "/projects/go-merkletrie/": ("Persistent Merkle trie", "A generic immutable trie with content-addressed storage and lazy snapshots."),
    ...
    "/projects/the-line/": ("Racing playground", "Editable roads, car setups, and two-car racecraft experiments."),
    "/notes/building-a-racing-line-playground/": ("Racing physics", "Building racing lines and overtaking experiments from tyre physics."),
    ...
    "/articles/typed-filtering-over-sqlite/": ("Typed filters", "How typed expressions become safe, exact SQLite query plans."),
    "/articles/migrating-mixology-from-bstore-to-sqlite/": ("Storage migration", "Mixology replaces bstore while preserving its application contracts."),
    ...
    "/articles/making-illegal-states-unrepresentable-in-go/": ("Modeled states", "F# modeling techniques clarify Go guarantees and tradeoffs."),
    ...
    "/notes/building-a-persistent-merkle-trie-in-go/": ("Merkle trie internals", "Canonical codecs and lazy snapshots build a persistent content-addressed trie."),
