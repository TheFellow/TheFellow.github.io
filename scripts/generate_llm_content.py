...
SUMMARIES = {
    ...
    "/series/weave/": ("Weave series", "From exhaustive semantic graphs to compact progressive source discovery."),
    ...
    "/articles/shrinking-a-semantic-graph-without-changing-its-meaning/": ("Navigation projection", "Retaining useful anchors and relationships cuts index cost drastically."),
    ...
    "/articles/measuring-agent-research-beyond-query-latency/": ("Practical agent research", "Outcome and payload measurements drive smaller progressive discovery."),
    "/articles/making-source-bodies-discoverable-without-copying-them/": ("Current-source discovery", "Semantic anchors and bounded ripgrep replace broad body postings."),
