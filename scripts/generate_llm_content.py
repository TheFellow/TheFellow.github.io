...
SUMMARIES = {
    ...
    "/articles/keeping-a-semantic-index-fresh-without-a-daemon/": ("Fresh indexes", "Query-driven refresh keeps semantic evidence aligned with live Git state."),
    ...
    "/articles/composing-source-rich-context-without-a-second-index/": ("Selected source context", "Compact discovery opens current source only after anchor selection."),
    ...
    "/articles/shrinking-a-semantic-graph-without-changing-its-meaning/": ("Format-5 navigation", "A small navigation profile keeps detail in current source."),
    ...
    "/articles/measuring-agent-research-beyond-query-latency/": ("Practical agent research", "Format-5 discovery is measured by answer quality and total agent work."),
    "/articles/making-source-bodies-discoverable-without-copying-them/": ("Current-source discovery", "Format-5 anchors combine with bounded ripgrep."),
    "/articles/serving-persistent-agent-queries-without-a-daemon/": ("Reusable local queries", "Foreground sessions and an idle broker reuse bounded read state."),
    "/articles/turning-cross-repository-soaks-into-indexing-contracts/": ("Cross-repository indexing soak", "A mixed-language matrix validates the format-5 provider contract."),
