...
SUMMARIES = {
    ...
    "/projects/weave/": ("Semantic indexing", "A Git-aware semantic index joining compiler facts and workspace knowledge."),
    ...
    "/series/weave/": ("Weave series", "An ordered path through Weave's fresh compiler-backed semantic graph."),
