<!-- Generated from https://thefellow.github.io/notes/octonions-and-the-standard-model-in-fsharp/ by scripts/generate_llm_content.py; do not edit. -->

# Octonions and the Standard Model in F#

Source: [https://thefellow.github.io/notes/octonions-and-the-standard-model-in-fsharp/](https://thefellow.github.io/notes/octonions-and-the-standard-model-in-fsharp/)

## Pyramid summary

- **~2 words:** Executable octonions
- **~8 words:** Non-associative multiplication produces a Furey-inspired eight-state particle pattern.
- **Expanded:** An executable tour from non-associative octonion multiplication to a Furey-inspired eight-state particle pattern.
...
<figure class="article-figure article-figure--compact">
  <img src="/assets/images/notes/octonions/fano-plane.png" alt="A Fano plane labeled e1 through e7 beside the seven oriented triples used to define octonion multiplication.">
