...
<figure class="article-figure article-figure--compact">
  <img src="/assets/images/notes/cedar/conformance.png" alt="The Cedar conformance corpus feeds the Rust reference implementation, cedar-go, and cedar-dotnet. Their language APIs differ while authorization semantics must agree.">
