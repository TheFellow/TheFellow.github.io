<!-- Generated from https://thefellow.github.io/notes/elliptic-curve-cryptography-from-first-principles/ by scripts/generate_llm_content.py; do not edit. -->

# From Groups to ECDSA: Elliptic-Curve Cryptography from First Principles

Source: [https://thefellow.github.io/notes/elliptic-curve-cryptography-from-first-principles/](https://thefellow.github.io/notes/elliptic-curve-cryptography-from-first-principles/)

## Pyramid summary

- **~2 words:** ECDSA foundations
- **~8 words:** A ground-up route through groups, finite fields, curves, and signatures.
- **Expanded:** A ground-up path to ECDSA through groups, finite fields, elliptic-curve point arithmetic, and scalar multiplication.
...
<figure class="ecc-figure ecc-figure--compact">
  <img src="/assets/images/notes/ecc/cyclic-group-z5.png" alt="A pentagon representing addition modulo 5 alongside the sequences generated by each nonzero element.">
...
<figure class="ecc-figure ecc-figure--square">
  <img src="/assets/images/notes/ecc/original/secp256k1-f223.png" alt="The points satisfying the secp256k1 equation over the finite field modulo 223.">
...
<figure class="ecc-figure">
  <img src="/assets/images/notes/ecc/curve-addition.png" alt="A line through points A and B intersects an elliptic curve at C, which is reflected across the horizontal axis to obtain A plus B.">
...
<figure class="ecc-figure ecc-figure--compact">
  <img src="/assets/images/notes/ecc/original/generated-points.png" alt="The first seven scalar multiples of the point 47 comma 71 on secp256k1 over the field modulo 223.">
...
<figure class="ecc-figure ecc-figure--compact">
  <img src="/assets/images/notes/ecc/ecdsa-verification.png" alt="A verification flow that calculates u and v, reconstructs the point R, and compares its x-coordinate to r.">
...
<figure class="ecc-figure ecc-figure--compact">
  <img src="/assets/images/notes/ecc/nonce-reuse.png" alt="A derivation of the private key e from two signatures that reused the same nonce k.">
