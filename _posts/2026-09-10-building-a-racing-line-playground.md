...
excerpt: "A fun physics project in Go: turning editable roads and tyre-force limits into racing lines, ghost comparisons, and two-car experiments in overtaking and defence."
icon: "racing"
accent: "#ffb454"
...
<figure class="article-figure">
  <img src="{{ '/assets/images/projects/the-line/club-loop.gif' | relative_url }}" alt="The Line cycling through a qualifying ghost on Club Loop, an over-under move, and a pass/repass battle with speed and position-gap charts." width="960" height="600">
