...
excerpt: "An ordered path through Weave's fresh compiler-backed graph, exact caching and storage, semantic comparison, and optional watch-mode warming."
order: 5
entries_label: "8 articles"
icon: "route"
accent: "#4dabf7"
