<!-- Generated from https://thefellow.github.io/resume/ by scripts/generate_llm_content.rb; do not edit. -->
...
A semantic port of the Cedar policy language, maintained against its upstream implementation and validated with the official conformance corpus.
...
Make difficult material approachable, including a ground-up tour of elliptic-curve cryptography from groups and finite fields through ECDSA.
