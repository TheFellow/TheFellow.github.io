...
last_modified_at: 2026-08-06 17:00:00 -0700
...
<figure class="article-figure">
  <img src="{{ '/assets/images/projects/arch-lint/enforced-boundary.png' | relative_url }}" alt="Two domains import their own public contracts through allowed green arrows. Dashed red arrows cross domain, internal, and presentation boundaries and terminate in an arch-lint build failure.">
