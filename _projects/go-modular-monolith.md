...
- The full pipeline, from commands and queries through authorization, persistence, events, audit records, and presentation surfaces, runs in integration tests without external infrastructure.
