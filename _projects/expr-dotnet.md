...
icon: "braces"
accent: "#f06595"
topics: ["Expression language", "Compiler", "Native AOT"]
toc: true
toc_sticky: true
---

<div class="project-meta"><span>C#</span><span>Expression language</span><span>Compiler</span><span>MIT</span><span>Updated {{ page.last_updated | date: "%B %-d, %Y" }}</span></div>
...
<figure class="article-figure">
  <img src="{{ '/assets/images/projects/expr-dotnet/compiler-pipeline.png' | relative_url }}" alt="Expr source passes through a lexer and parser into a public immutable syntax tree, then through static checking and semantic patchers, optimizer rewrites, bytecode compilation, and an isolated bounded virtual machine evaluation.">
