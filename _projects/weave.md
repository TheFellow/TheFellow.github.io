...
The first tagged release is still ahead; its workflow is already shaped around checksummed core archives and same-version .NET adapter artifacts so packaging and runtime limitations remain visible parts of the product.
