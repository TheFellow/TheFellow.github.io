<!-- Generated from https://thefellow.github.io/articles/migrating-mixology-from-bstore-to-sqlite/ by scripts/generate_llm_content.py; do not edit. -->

# Migrating Mixology from bstore to SQLite

Source: [https://thefellow.github.io/articles/migrating-mixology-from-bstore-to-sqlite/](https://thefellow.github.io/articles/migrating-mixology-from-bstore-to-sqlite/)

## Pyramid summary

- **~2 words:** Storage migration
- **~8 words:** Mixology replaces bstore while preserving its application contracts.
- **Expanded:** How Mixology replaced its embedded bstore backend with SQLite while preserving transactions, typed queries, domain ownership, filtering semantics, and application errors.

## Full content

**Part 13 of [Building Mixology](/series/mixology.md).**
...
The [typed filtering layer](/articles/typed-filtering-over-sqlite.md) was intentionally concrete about bstore. Its first adapter translated checked Expr trees into bstore filters, hydrated tags, and evaluated the complete expression as a residual authority.
