...
The format-5 Go provider retains build-selected package, type, function, and method anchors plus direct package dependencies, without type checking or referenced-object materialization. External package identities and other open endpoints can still appear on retained relationships without requiring a stored symbol.
