<!-- Generated from https://thefellow.github.io/articles/typed-filtering-over-bstore/ by scripts/generate_llm_content.py; do not edit. -->

# Typed Filtering over bstore

Source: [https://thefellow.github.io/articles/typed-filtering-over-bstore/](https://thefellow.github.io/articles/typed-filtering-over-bstore/)

## Pyramid summary

- **~2 words:** Typed filters
- **~8 words:** How typed expressions become safe, exact bstore query plans.
- **Expanded:** How Mixology gives people and programs one typed filter language, then deliberately translates its safe subset into bstore instead of pretending persistence is interchangeable.
...
The completed [.NET semantic port](/projects/modular-monolith.md) now applies the same division with [Expr for .NET](/projects/expr-dotnet.md) and EF Core. [`Mixology.Filtering`](https://github.com/TheFellow/modular-monolith/tree/master/src/Mixology.Filtering) originally owned a lexer, parser, checker, formatter, and evaluator while the Expr package was being built. The 0.1.0 integration removes that duplicate language machinery. Expr now supplies the checked public AST, canonical printer, optimizer, and exact virtual-machine evaluation.
