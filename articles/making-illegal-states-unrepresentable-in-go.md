<!-- Generated from https://thefellow.github.io/articles/making-illegal-states-unrepresentable-in-go/ by scripts/generate_llm_content.py; do not edit. -->

# Making Illegal States Unrepresentable in Go

Source: [https://thefellow.github.io/articles/making-illegal-states-unrepresentable-in-go/](https://thefellow.github.io/articles/making-illegal-states-unrepresentable-in-go/)

## Pyramid summary

- **~2 words:** Modeled states
- **~8 words:** F# techniques make Go domain constraints explicit and enforceable.
- **Expanded:** What F#'s algebraic types teach about modeling identifiers, validated values, closed variants, and workflow stages in Go, including the places where constructors and linters must complete the guarantee.
...
<figure class="article-figure">
  <img src="/assets/images/articles/illegal-states/state-space.png" alt="Four combinations created by independent lifecycle options include two invalid states. Replacing them with Draft and Published cases leaves only meaningful states and attaches publication time to Published.">
...
- My [type-safe linear algebra in F#](/notes/type-safe-linear-algebra-in-fsharp.md) note shows the same idea applied to matrix dimensions.
- My [enumstruct project](/projects/enumstruct.md) explores exhaustive pointer-union handling in Go.
