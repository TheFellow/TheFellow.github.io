<!-- Generated from https://thefellow.github.io/articles/comparing-semantic-graphs-without-mutating-the-worktree/ by scripts/generate_llm_content.py; do not edit. -->

# Comparing Semantic Graphs Without Mutating the Worktree

Source: [https://thefellow.github.io/articles/comparing-semantic-graphs-without-mutating-the-worktree/](https://thefellow.github.io/articles/comparing-semantic-graphs-without-mutating-the-worktree/)

## Pyramid summary

- **~2 words:** Semantic snapshot diffs
- **~8 words:** Exact Git sides become bounded graph, API, impact, and affected-test evidence.
- **Expanded:** How Weave compares exact Git revisions and dirty worktrees through the same provider pipeline, separates source changes from graph changes, and makes bounded impact and test claims with evidence.
