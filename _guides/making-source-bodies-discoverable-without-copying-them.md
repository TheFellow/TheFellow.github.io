...
excerpt: "How Weave replaced broad body-token postings with bounded ripgrep discovery over current source while keeping structured document anchors in its navigation index."
...
icon: "filter"
accent: "#fab005"
topics: ["Code navigation", "Content discovery", "Performance"]
---
