---
title: "Shrinking a Semantic Graph Without Changing Its Meaning"
date: 2026-08-07 12:45:59 -0700
last_modified_at: 2026-08-07 12:45:59 -0700
excerpt: "How Weave separates its stable graph model from a compact private schema with numeric identities, interned strings, hot and cold records, exact ordering, and rebuild-only evolution."
...
icon: "layers"
accent: "#22b8cf"
topics: ["Storage design", "Semantic graphs", "Performance"]
---
...
<figure class="article-figure">
  <img src="{{ '/assets/images/articles/weave/compact-storage.svg' | relative_url }}" alt="Stable public graph facts enter a private storage codec. Long repeated strings become reference-counted intern and entity records. Narrow hot records hold numeric lookup keys and canonical ordering fields, while cold detail records hold ranges, providers, evidence, and document references. Batched hydration reconstructs the unchanged public graph, and verification checks every indirection and reference count.">
...
Full export performs the same reconstruction across every record family and sorts the public snapshot canonically. The machine-wide [aggregate cache](/articles/caching-a-federated-graph-without-weakening-freshness/) receives its hot symbol and edge stream through this codec too. Compact local storage does not create an alternative fact type for acceleration.
