<!-- Generated from https://thefellow.github.io/guides/growing-a-reciprocal-domain-workflow/ by scripts/generate_llm_content.py; do not edit. -->

# Growing a Reciprocal Domain Workflow

Source: [https://thefellow.github.io/guides/growing-a-reciprocal-domain-workflow/](https://thefellow.github.io/guides/growing-a-reciprocal-domain-workflow/)
...
The workshop builds on [Turning Cross-Domain Calls into Enforced Boundaries](/guides/turning-cross-domain-calls-into-enforced-boundaries.md). That guide derives one-way reactions from an ingredient deletion. This one asks what changes when two stateful domains continually affect one another.
