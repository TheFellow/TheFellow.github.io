...
\definecolor{violet}{HTML}{B197FC}\definecolor{ink}{HTML}{E9ECEF}\definecolor{panel}{HTML}{211C1D}
\begin{document}
\begin{tikzpicture}[text=ink,point/.style={circle,fill=pink,text=white,minimum size=9mm,font=\bfseries},line/.style={ink!75,line width=1.1pt}]
 ...
 \fill[panel,rounded corners=8pt] (-4.15,-2.75) rectangle (10.35,4.55);
