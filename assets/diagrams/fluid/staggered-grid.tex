...
\definecolor{pink}{HTML}{F72585}\definecolor{blue}{HTML}{228BE6}\definecolor{green}{HTML}{2F9E44}\definecolor{ink}{HTML}{343A40}\definecolor{soft}{HTML}{F1F3F5}
\begin{document}
\begin{tikzpicture}[pressure/.style={circle,fill=pink,text=white,minimum size=7mm,font=\bfseries},velocity/.style={-{Latex[length=2.5mm]},very thick,blue},grid/.style={ink!35,line width=.8pt}]
 \fill[soft] (-.2,-.2) rectangle (6.2,4.2);
