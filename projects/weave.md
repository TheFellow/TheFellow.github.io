...
- **~8 words:** A Git-aware semantic index joining compiler facts and workspace knowledge.
- **Expanded:** A local-first semantic index that connects compiler facts, repository structure, and documents through bounded deterministic queries.
